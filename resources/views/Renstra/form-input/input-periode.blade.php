                ...
                <div class="p-3" style="background: white">
                    ...
                    <form method="POST" action="/create/periode">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($periode_last == null)
                                <input type="number" class="form-control @error('tahunAwal') is-invalid @enderror"
                                    id="tahunAwal" placeholder="Tahun Awal" name="tahunAwal" style="width: auto">
                            @else
                                <input type="number" class="form-control @error('tahunAwal') is-invalid @enderror"
                                    id="tahunAwal" placeholder="Tahun Awal" name="tahunAwal" style="width: auto"
                                    value="{{ $periode_last->tahun_akhir + 1 }}">
                            @endif
                            @error('tahunAwal')
                                <div class="invalid-feedback mb-2"> {{ $message }} </div>
                            @enderror
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="gap: 1%">
                        ...
                        <a href="{{route('step-2')}}" class="btn btnAdd" style="background:#008800; color:white;">
                            Next </a>
                    </div>
                    </form>
                </div>
